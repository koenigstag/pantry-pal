...
export function LocationTabs({
  ...
  return (
    <nav aria-label={messages.storage.locations} className="px-4 pb-3 md:px-8">
      {/*
        One scrolling row, the + after the last tab: with many locations it comes
        into view as the row is scrolled to its end. Padding keeps focus rings
        clear of the overflow clipping.
      */}
      <div className="scrollbar-none flex items-center gap-2 overflow-x-auto p-1">
        ...
        <button
          type="button"
          aria-label={messages.storage.editLocations}
          title={messages.storage.editLocations}
