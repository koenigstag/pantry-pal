...
ALTER TABLE "locations" ADD COLUMN "is_fallback" boolean DEFAULT false NOT NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "locations_household_fallback_idx" ON "locations" USING btree ("household_id") WHERE is_fallback;--> statement-breakpoint
ALTER TABLE "item_events" ADD CONSTRAINT "item_events_type_check" CHECK (type in ('added', 'updated', 'opened', 'consumed', 'discarded', 'restored', 'deleted'));--> statement-breakpoint
ALTER TABLE "locations" ADD CONSTRAINT "locations_fallback_not_deleted" CHECK (not is_fallback or deleted_at is null);
